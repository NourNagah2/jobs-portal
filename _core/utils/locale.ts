import { type ECountrySeo, type ELanguage, getApiCountryForSeoCountry, RTLLanguages } from '_core/constants/locale';
import type { TLocaleAPI, TLocaleConfig, TLocaleSEO } from '_core/types/locale';
